...
public sealed class TechnicalHierarchyServiceTests
{
    ...
    private sealed class Fixture:IAsyncDisposable
    {
        ...
        {
            var fae1=new FaenaEntity{Code="FAE-1",Name="Faena Uno",IsActive=true};var fae2=new FaenaEntity{Code="FAE-2",Name="Faena Dos",IsActive=true};var fam1=new EquipmentFamilyEntity{Code="FAM-1",Name="Familia Uno",IsActive=true};var fam2=new EquipmentFamilyEntity{Code="FAM-2",Name="Familia Dos",IsActive=true};var state=new AssetOperationalStateEntity{Code="OPERATIVO_FAENA",Name="Operativo",IsActive=true};
            db.AddRange(fae1,fae2,fam1,fam2,state);db.Assets.AddRange(new AssetEntity{Code="ACT-1",Name="Activo Uno",Faena=fae1,Family=fam1,OperationalState=state,AssetType="Equipo",RecordStatus="vigente"},new AssetEntity{Code="ACT-2",Name="Activo Dos",Faena=fae1,Family=fam2,OperationalState=state,AssetType="Equipo",RecordStatus="vigente"},new AssetEntity{Code="ACT-3",Name="Activo Tres",Faena=fae2,Family=fam2,OperationalState=state,AssetType="Equipo",RecordStatus="vigente"});await db.SaveChangesAsync();
        }
