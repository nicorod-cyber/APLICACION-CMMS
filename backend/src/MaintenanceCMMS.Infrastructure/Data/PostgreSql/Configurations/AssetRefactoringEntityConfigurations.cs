...
public sealed class OperationalUnitComponentConfiguration : IEntityTypeConfiguration<OperationalUnitComponentEntity>
{
    ...
    {
        b.ToTable("componentes_unidad_operativa"); b.ConfigureBase(); b.Property(x=>x.OperationalUnitId).HasColumnName("unidad_operativa_id"); b.Property(x=>x.AssetId).HasColumnName("activo_id"); b.Property(x=>x.ComponentRoleId).HasColumnName("rol_componente_id"); b.Property(x=>x.InstalledAtUtc).HasColumnName("fecha_montaje_utc").HasColumnType("timestamptz"); b.Property(x=>x.RemovedAtUtc).HasColumnName("fecha_desmontaje_utc").HasColumnType("timestamptz"); b.Property(x=>x.InstallationWorkOrderId).HasColumnName("orden_trabajo_montaje_id"); b.Property(x=>x.RemovalWorkOrderId).HasColumnName("orden_trabajo_desmontaje_id");
