...
public sealed class TechnicalLocationEntity : SqlServerEntity
{
...
public sealed class TechnicalNodeEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class TechnicalNodeFamilyEntity : SqlServerEntity
{
...
public sealed class TechnicalNodeAssetEntity : SqlServerEntity
{
    public Guid TechnicalNodeId { get; set; }
    public TechnicalNodeEntity TechnicalNode { get; set; } = null!;
...
public sealed class TechnicalNodeAliasEntity : SqlServerEntity
{
    public Guid TechnicalNodeId { get; set; }
    public TechnicalNodeEntity TechnicalNode { get; set; } = null!;
