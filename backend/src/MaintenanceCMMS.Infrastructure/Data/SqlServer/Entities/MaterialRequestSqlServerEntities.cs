...
public sealed class MaterialRequestEntity : SqlServerEntity
{
...
public sealed class MaterialRequestItemEntity : SqlServerEntity
{
...
public sealed class MaterialRequestStatusHistoryEntity : SqlServerEntity
{
    public Guid MaterialRequestId { get; set; }
    public MaterialRequestEntity MaterialRequest { get; set; } = null!;
