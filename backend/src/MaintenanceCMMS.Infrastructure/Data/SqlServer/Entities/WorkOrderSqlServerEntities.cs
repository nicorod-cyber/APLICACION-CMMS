...
public sealed class WorkCatalogEntity : SqlServerEntity
{
...
public sealed class WorkNotificationEntity : SqlServerEntity
{
...
public sealed class DocumentaryWorkOrderRequirementEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
...
public sealed class WorkOrderAssetEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
    public Guid AssetId { get; set; }
...
public sealed class WorkOrderTaskEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
...
public sealed class WorkOrderTechnicianEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
...
public sealed class WorkOrderTaskStatusHistoryEntity : SqlServerEntity
{
...
public sealed class WorkOrderLaborEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
    public Guid TaskId { get; set; }
...
public sealed class WorkOrderEvidenceEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
    public Guid TaskId { get; set; }
...
public sealed class WorkOrderSparePartEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
    public Guid TaskId { get; set; }
...
public sealed class ChecklistTemplateEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class ChecklistTemplateItemEntity : SqlServerEntity
{
...
public sealed class WorkOrderChecklistEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
    public Guid TaskId { get; set; }
...
public sealed class WorkOrderSignatureEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
...
public sealed class WorkOrderStatusHistoryEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
    public WorkOrderEntity WorkOrder { get; set; } = null!;
    public Guid PreviousStatusId { get; set; }
...
public sealed class DocumentWorkOrderEntity : SqlServerEntity
{
