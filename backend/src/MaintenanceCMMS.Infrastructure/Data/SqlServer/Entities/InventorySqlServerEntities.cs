...
public sealed class InventoryCatalogEntity : SqlServerEntity
{
...
public sealed class WarehouseEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class WarehouseLocationEntity : SqlServerEntity
{
...
public sealed class SparePartEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
...
public sealed class WarehouseStockEntity : SqlServerEntity
{
...
public sealed class StockMovementEntity : SqlServerEntity
{
...
public sealed class StockReservationEntity : SqlServerEntity
{
...
public sealed class StockTransferEntity : SqlServerEntity
{
