...
// enforced by SQL Server rather than by application-side dictionaries.

public sealed class AvailabilityContractEntity : SqlServerEntity
{
...
public sealed class AvailabilityContractAssignmentEntity : SqlServerEntity
{
...
public sealed class AvailabilityEventEntity : SqlServerEntity
{
    public Guid ContractId { get; set; }
    public AvailabilityContractEntity Contract { get; set; } = null!;
...
public sealed class PreventivePlanEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class PreventivePlanScopeEntity : SqlServerEntity
{
...
public sealed class PreventiveEvaluationEntity : SqlServerEntity
{
    public Guid PreventivePlanId { get; set; }
    public PreventivePlanEntity PreventivePlan { get; set; } = null!;
    public Guid AssetId { get; set; }
...
public sealed class PreventiveHistoryEntity : SqlServerEntity
{
    public Guid PreventivePlanId { get; set; }
    public PreventivePlanEntity PreventivePlan { get; set; } = null!;
    public Guid AssetId { get; set; }
...
public sealed class WorkshopEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class WorkOrderScheduleEntity : SqlServerEntity
{
    public Guid WorkOrderId { get; set; }
...
public sealed class ScheduleDependencyEntity : SqlServerEntity
{
...
public sealed class ScheduleAlertEntity : SqlServerEntity
{
...
public sealed class SupplierEntity : SqlServerEntity
{
...
public sealed class ProcurementRequestEntity : SqlServerEntity
{
...
public sealed class ProcurementRequestLineEntity : SqlServerEntity
{
...
public sealed class PurchaseOrderEntity : SqlServerEntity
{
...
public sealed class PurchaseOrderLineEntity : SqlServerEntity
{
...
public sealed class ProcurementReceiptEntity : SqlServerEntity
{
    public Guid ProcurementRequestId { get; set; }
    public ProcurementRequestEntity ProcurementRequest { get; set; } = null!;
    public Guid? PurchaseOrderId { get; set; }
...
public sealed class ProcurementReceiptLineEntity : SqlServerEntity
{
...
public sealed class ImportEntity : SqlServerEntity
{
...
public sealed class ImportRowEntity : SqlServerEntity
{
...
public sealed class ImportErrorEntity : SqlServerEntity
{
    public Guid ImportId { get; set; }
    public ImportEntity Import { get; set; } = null!;
    public int RowNumber { get; set; }
...
public sealed class ImportEventEntity : SqlServerEntity
{
    public Guid ImportId { get; set; }
    public ImportEntity Import { get; set; } = null!;
    public int Status { get; set; }
