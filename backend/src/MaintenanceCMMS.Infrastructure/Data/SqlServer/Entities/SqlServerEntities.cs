...
public sealed class AppUserEntity : SqlServerEntity
{
...
public sealed class RoleEntity : SqlServerEntity
{
...
public sealed class PermissionEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public bool IsActive { get; set; } = true;
...
public sealed class UserRoleEntity : SqlServerEntity
{
...
public sealed class RolePermissionEntity : SqlServerEntity
{
    public Guid RoleId { get; set; }
    public RoleEntity Role { get; set; } = null!;
...
public sealed class UserFaenaEntity : SqlServerEntity
{
    public Guid UserId { get; set; }
    public AppUserEntity User { get; set; } = null!;
...
public sealed class FaenaEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class AssetOperationalStateEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class AssetTypeEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class EquipmentFamilyEntity : SqlServerEntity
{
...
public sealed class AssetEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public Guid AssetTypeId { get; set; }
...
public sealed class AssetStateEventEntity : SqlServerEntity
{
...
public sealed class AssetTransferEntity : SqlServerEntity
{
    public Guid AssetId { get; set; }
    public AssetEntity Asset { get; set; } = null!;
...
public sealed class AssetLocationPeriodEntity : SqlServerEntity
{
    public Guid AssetId { get; set; }
    public AssetEntity Asset { get; set; } = null!;
    public Guid? FaenaId { get; set; }
...
public sealed class AssetPhysicalLocationPeriodEntity : SqlServerEntity
{
    public Guid AssetId { get; set; }
    public AssetEntity Asset { get; set; } = null!;
...
public sealed class AssetIdentifierAliasEntity : SqlServerEntity
{
    public Guid AssetId { get; set; }
    public AssetEntity Asset { get; set; } = null!;
...
public sealed class DocumentTypeEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public string? Description { get; set; }
...
public sealed class DocumentEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
...
public sealed class DocumentVersionEntity : SqlServerEntity
{
...
public sealed class FileMetadataEntity : SqlServerEntity
{
...
public sealed class DocumentAssetEntity : SqlServerEntity
{
    public Guid DocumentId { get; set; }
    public DocumentEntity Document { get; set; } = null!;
    public Guid AssetId { get; set; }
...
public sealed class DocumentFaenaEntity : SqlServerEntity
{
    public Guid DocumentId { get; set; }
    public DocumentEntity Document { get; set; } = null!;
    public Guid FaenaId { get; set; }
...
public sealed class AuditLogEntity : SqlServerEntity
{
    public DateTimeOffset OccurredAtUtc { get; set; } = DateTimeOffset.UtcNow;
    public string UserId { get; set; } = string.Empty;
...
public sealed class AssetAttributeDefinitionEntity : SqlServerEntity
{
    public Guid AssetTypeId { get; set; }
    public AssetTypeEntity AssetType { get; set; } = null!;
...
public sealed class AssetAttributeValueEntity : SqlServerEntity
{
    public Guid AssetId { get; set; }
    public AssetEntity Asset { get; set; } = null!;
...
public sealed class AssetReadingEntity : SqlServerEntity
{
    public Guid AssetId { get; set; }
    public AssetEntity Asset { get; set; } = null!;
...
public sealed class AssetDocumentRequirementEntity : SqlServerEntity
{
    public Guid AssetTypeId { get; set; }
    public AssetTypeEntity AssetType { get; set; } = null!;
    public Guid? EquipmentFamilyId { get; set; }
...
public sealed class DocumentRequirementMatrixEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public int VersionNumber { get; set; }
...
public sealed class DocumentRequirementMatrixItemEntity : SqlServerEntity
{
...
public sealed class OperationalUnitTypeEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public string? Description { get; set; }
...
public sealed class OperationalUnitEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
...
public sealed class OperationalUnitComponentRoleEntity : SqlServerEntity
{
    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public string? Description { get; set; }
...
public sealed class OperationalUnitCompositionRuleEntity : SqlServerEntity
{
    public Guid OperationalUnitTypeId { get; set; }
    public OperationalUnitTypeEntity OperationalUnitType { get; set; } = null!;
...
public sealed class OperationalUnitCompositionRuleAllowedAssetEntity : SqlServerEntity
{
...
public sealed class OperationalUnitComponentEntity : SqlServerEntity
{
    public Guid OperationalUnitId { get; set; }
