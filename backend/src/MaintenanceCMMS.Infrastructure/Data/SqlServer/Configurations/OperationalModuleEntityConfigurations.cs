...
public sealed class AvailabilityContractConfiguration : IEntityTypeConfiguration<AvailabilityContractEntity>
{
    public void Configure(EntityTypeBuilder<AvailabilityContractEntity> b)
    {
        ...
        b.Property(x => x.StartsAtUtc).HasColumnName("fecha_inicio_utc").HasColumnType("datetimeoffset"); b.Property(x => x.EndsAtUtc).HasColumnName("fecha_fin_utc").HasColumnType("datetimeoffset");
...
public sealed class AvailabilityContractAssignmentConfiguration : IEntityTypeConfiguration<AvailabilityContractAssignmentEntity>
{
    public void Configure(EntityTypeBuilder<AvailabilityContractAssignmentEntity> b)
    {
        ...
        b.Property(x => x.StartsAtUtc).HasColumnName("fecha_inicio_utc").HasColumnType("datetimeoffset"); b.Property(x => x.EndsAtUtc).HasColumnName("fecha_fin_utc").HasColumnType("datetimeoffset"); b.Property(x => x.IsActive).HasColumnName("activo"); b.Property(x => x.CreatedByUserId).HasColumnName("creado_por_usuario_id").HasMaxLength(120).IsRequired();
        b.HasIndex(x => new { x.ContractId, x.AssetId, x.IsActive }).IsUnique().HasFilter("activo_id IS NOT NULL AND activo = 1"); b.HasIndex(x => new { x.ContractId, x.OperationalUnitId, x.IsActive }).IsUnique().HasFilter("unidad_operativa_id IS NOT NULL AND activo = 1");
...
public sealed class PreventivePlanConfiguration : IEntityTypeConfiguration<PreventivePlanEntity>
{
    public void Configure(EntityTypeBuilder<PreventivePlanEntity> b)
    {
        ...
        b.Property(x => x.StartsAtUtc).HasColumnName("fecha_inicio_utc").HasColumnType("datetimeoffset"); b.Property(x => x.LastExecutedAtUtc).HasColumnName("ultima_ejecucion_utc").HasColumnType("datetimeoffset"); b.Property(x => x.LastExecutedHours).HasColumnName("ultima_ejecucion_horas").HasPrecision(18, 2); b.Property(x => x.LastExecutedKilometers).HasColumnName("ultima_ejecucion_km").HasPrecision(18, 2); b.Property(x => x.NextDueAtUtc).HasColumnName("proxima_fecha_utc").HasColumnType("datetimeoffset"); b.Property(x => x.NextDueHours).HasColumnName("proxima_hora").HasPrecision(18, 2); b.Property(x => x.NextDueKilometers).HasColumnName("proximo_km").HasPrecision(18, 2); b.Property(x => x.IsActive).HasColumnName("activo"); b.Property(x => x.CreatedByUserId).HasColumnName("creado_por_usuario_id").HasMaxLength(120).IsRequired(); b.Property(x => x.UpdatedByUserId).HasColumnName("actualizado_por_usuario_id").HasMaxLength(120);
...
public sealed class WorkshopConfiguration : IEntityTypeConfiguration<WorkshopEntity>
{
    ...
    {
        b.ToTable("talleres"); b.ConfigureBase(); b.Property(x => x.Code).HasColumnName("codigo").HasMaxLength(80).IsRequired(); b.Property(x => x.Name).HasColumnName("nombre").HasMaxLength(240).IsRequired(); b.Property(x => x.EquipmentCapacity).HasColumnName("capacidad_equipos"); b.Property(x => x.Commune).HasColumnName("comuna").HasMaxLength(160); b.Property(x => x.SupervisorUserId).HasColumnName("supervisor_usuario_id"); b.Property(x => x.IsActive).HasColumnName("activo"); b.Property(x => x.CreatedByUserId).HasColumnName("creado_por_usuario_id").HasMaxLength(120).IsRequired(); b.Property(x => x.UpdatedByUserId).HasColumnName("actualizado_por_usuario_id").HasMaxLength(120);
        b.HasIndex(x => x.Code).IsUnique(); b.HasIndex(x => x.SupervisorUserId); b.HasOne(x => x.SupervisorUser).WithMany().HasForeignKey(x => x.SupervisorUserId).OnDelete(DeleteBehavior.Restrict); b.ToTable(t => t.HasCheckConstraint("ck_talleres_capacidad_equipos", "capacidad_equipos >= 0"));
    }
}
