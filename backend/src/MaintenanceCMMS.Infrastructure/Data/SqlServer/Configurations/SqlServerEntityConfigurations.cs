...
internal static class SqlServerConfigurationHelpers
{
    public static void ConfigureBase<TEntity>(this EntityTypeBuilder<TEntity> builder)
        where TEntity : SqlServerEntity
    {
        builder.HasKey(entity => entity.Id);
        builder.Property(entity => entity.Id).HasColumnName("id");
        builder.Property(entity => entity.CreatedAtUtc).HasColumnName("created_at_utc").HasColumnType("datetimeoffset").IsRequired();
        builder.Property(entity => entity.UpdatedAtUtc).HasColumnName("updated_at_utc").HasColumnType("datetimeoffset");
...
public sealed class RoleConfiguration : IEntityTypeConfiguration<RoleEntity>
{
    public void Configure(EntityTypeBuilder<RoleEntity> builder)
    {
        ...
        builder.ConfigureBase();
        builder.Property(entity => entity.Code).HasColumnName("codigo").HasMaxLength(120).UseCollation("Latin1_General_100_CS_AS").IsRequired();
...
public sealed class UserRoleConfiguration : IEntityTypeConfiguration<UserRoleEntity>
{
    public void Configure(EntityTypeBuilder<UserRoleEntity> builder)
    {
        ...
        builder.Property(entity => entity.AssignedAtUtc).HasColumnName("asignado_at_utc").HasColumnType("datetimeoffset");
        builder.Property(entity => entity.UnassignedByUserId).HasColumnName("desasignado_por_usuario_id").HasMaxLength(120);
        builder.Property(entity => entity.UnassignedAtUtc).HasColumnName("desasignado_at_utc").HasColumnType("datetimeoffset");
...
public sealed class FaenaConfiguration : IEntityTypeConfiguration<FaenaEntity>
{
    public void Configure(EntityTypeBuilder<FaenaEntity> builder)
    {
        ...
        builder.Property(entity => entity.AdministradorContrato).HasColumnName("administrador_contrato").HasColumnType("nvarchar(max)");
...
public sealed class AssetStateEventConfiguration : IEntityTypeConfiguration<AssetStateEventEntity>
{
    public void Configure(EntityTypeBuilder<AssetStateEventEntity> builder)
    {
        ...
        builder.Property(entity => entity.OccurredAtUtc).HasColumnName("fecha_evento_utc").HasColumnType("datetimeoffset");
...
public sealed class DocumentConfiguration : IEntityTypeConfiguration<DocumentEntity>
{
    public void Configure(EntityTypeBuilder<DocumentEntity> builder)
    {
        ...
        builder.Property(entity => entity.AnnulledAtUtc).HasColumnName("anulado_at_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(entity => entity.ValidatedAtUtc).HasColumnName("validado_at_utc").HasColumnType("datetimeoffset");
        builder.Property(entity => entity.RejectedByUserId).HasColumnName("rechazado_por_usuario_id").HasMaxLength(120);
        builder.Property(entity => entity.RejectedAtUtc).HasColumnName("rechazado_at_utc").HasColumnType("datetimeoffset");
        ...
        builder.HasIndex(entity => new { entity.RequirementAssetId, entity.RequirementMatrixItemId }).IsUnique()
            .HasFilter("activo_requisito_activo_id IS NOT NULL AND requisito_matriz_item_id IS NOT NULL AND anulado = 0 AND historico = 0");
    }
}
...
public sealed class DocumentVersionConfiguration : IEntityTypeConfiguration<DocumentVersionEntity>
{
    public void Configure(EntityTypeBuilder<DocumentVersionEntity> builder)
    {
        ...
        builder.Property(entity => entity.UploadedAtUtc).HasColumnName("fecha_carga_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(entity => entity.ValidatedByUserId).HasColumnName("validado_por_usuario_id").HasMaxLength(120);
        builder.Property(entity => entity.ValidatedAtUtc).HasColumnName("validado_utc").HasColumnType("datetimeoffset");
        builder.Property(entity => entity.RejectedByUserId).HasColumnName("rechazado_por_usuario_id").HasMaxLength(120);
        builder.Property(entity => entity.RejectedAtUtc).HasColumnName("rechazado_utc").HasColumnType("datetimeoffset");
        builder.Property(entity => entity.RejectReason).HasColumnName("motivo_rechazo").HasMaxLength(500);
...
public sealed class FileMetadataConfiguration : IEntityTypeConfiguration<FileMetadataEntity>
{
    public void Configure(EntityTypeBuilder<FileMetadataEntity> builder)
    {
        ...
        builder.Property(entity => entity.DeletedAtUtc).HasColumnName("eliminado_at_utc").HasColumnType("datetimeoffset");
        builder.Property(entity => entity.DeletedByUserId).HasColumnName("eliminado_por_usuario_id").HasMaxLength(120);
        builder.Property(entity => entity.MetadataJson).HasColumnName("metadata").HasColumnType("nvarchar(max)");
...
public sealed class AuditLogConfiguration : IEntityTypeConfiguration<AuditLogEntity>
{
    public void Configure(EntityTypeBuilder<AuditLogEntity> builder)
    {
        ...
        builder.ConfigureBase();
        builder.Property(entity => entity.OccurredAtUtc).HasColumnName("occurred_at_utc").HasColumnType("datetimeoffset");
        builder.Property(entity => entity.UserId).HasColumnName("usuario_id").HasMaxLength(120).IsRequired();
