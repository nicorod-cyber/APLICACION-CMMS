...
public sealed class AssetTransferConfiguration : IEntityTypeConfiguration<AssetTransferEntity>
{
    public void Configure(EntityTypeBuilder<AssetTransferEntity> builder)
    {
        ...
        builder.Property(x => x.EffectiveAtUtc).HasColumnName("fecha_efectiva_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(x => x.RegisteredAtUtc).HasColumnName("fecha_registro_utc").HasColumnType("datetimeoffset");
        ...
        builder.ToTable(table => table.HasCheckConstraint("ck_traslados_activo_origen_destino", "faena_destino_id IS NOT NULL AND (faena_origen_id IS NULL OR faena_origen_id <> faena_destino_id)"));
    }
}
...
public sealed class AssetLocationPeriodConfiguration : IEntityTypeConfiguration<AssetLocationPeriodEntity>
{
    public void Configure(EntityTypeBuilder<AssetLocationPeriodEntity> builder)
    {
        ...
        builder.Property(x => x.ValidFromUtc).HasColumnName("vigencia_desde_utc").HasColumnType("datetimeoffset");
        builder.Property(x => x.ValidToUtc).HasColumnName("vigencia_hasta_utc").HasColumnType("datetimeoffset");
...
public sealed class AssetPhysicalLocationPeriodConfiguration : IEntityTypeConfiguration<AssetPhysicalLocationPeriodEntity>
{
    public void Configure(EntityTypeBuilder<AssetPhysicalLocationPeriodEntity> builder)
    {
        ...
        builder.Property(x => x.AssetId).HasColumnName("activo_id"); builder.Property(x => x.LocationType).HasColumnName("tipo_ubicacion").HasMaxLength(16).IsRequired(); builder.Property(x => x.FaenaId).HasColumnName("faena_id"); builder.Property(x => x.WorkshopId).HasColumnName("taller_id"); builder.Property(x => x.ValidFromUtc).HasColumnName("vigencia_desde_utc").HasColumnType("datetimeoffset"); builder.Property(x => x.ValidToUtc).HasColumnName("vigencia_hasta_utc").HasColumnType("datetimeoffset"); builder.Property(x => x.Reason).HasColumnName("motivo").HasMaxLength(1000); builder.Property(x => x.RegisteredByUserId).HasColumnName("registrado_por_usuario_id").HasMaxLength(120).IsRequired(); builder.Property(x => x.WorkOrderId).HasColumnName("orden_trabajo_id"); builder.Property(x => x.OperationalUnitId).HasColumnName("unidad_operativa_id"); builder.Property(x => x.Observations).HasColumnName("observaciones").HasMaxLength(2000);
...
public sealed class DocumentaryWorkOrderRequirementConfiguration : IEntityTypeConfiguration<DocumentaryWorkOrderRequirementEntity>
{
    public void Configure(EntityTypeBuilder<DocumentaryWorkOrderRequirementEntity> builder)
    {
        ...
        builder.Property(x => x.CompletedAtUtc).HasColumnName("completado_utc").HasColumnType("datetimeoffset");
