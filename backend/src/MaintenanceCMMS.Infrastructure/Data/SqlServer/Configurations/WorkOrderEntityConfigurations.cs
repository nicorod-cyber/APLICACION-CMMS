...
namespace MaintenanceCMMS.Infrastructure.Data.SqlServer.Configurations;
...
public sealed class WorkNotificationConfiguration : IEntityTypeConfiguration<WorkNotificationEntity>
{
    public void Configure(EntityTypeBuilder<WorkNotificationEntity> builder)
    {
        ...
        builder.Property(e => e.DetectedAtUtc).HasColumnName("fecha_deteccion_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.CreatedByUserAtUtc).HasColumnName("fecha_creacion_usuario_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(e => e.EvaluatedAtUtc).HasColumnName("evaluado_at_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.ApprovedByUserId).HasColumnName("aprobado_por_usuario_id").HasMaxLength(120);
        builder.Property(e => e.ApprovedAtUtc).HasColumnName("aprobado_at_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.RejectedByUserId).HasColumnName("rechazado_por_usuario_id").HasMaxLength(120);
        builder.Property(e => e.RejectedAtUtc).HasColumnName("rechazado_at_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(e => e.AnnulledAtUtc).HasColumnName("anulado_at_utc").HasColumnType("datetimeoffset");
...
public sealed class WorkOrderConfiguration : IEntityTypeConfiguration<WorkOrderEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderEntity> builder)
    {
        ...
        builder.Property(e => e.ScheduledAtUtc).HasColumnName("fecha_programada_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.ScheduledStartUtc).HasColumnName("inicio_programado_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.ScheduledEndUtc).HasColumnName("fin_programado_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.CreatedByUserId).HasColumnName("creado_por_usuario_id").HasMaxLength(120).IsRequired();
        builder.Property(e => e.CreatedByUserAtUtc).HasColumnName("creado_por_usuario_at_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(e => e.SupervisorAssignedAtUtc).HasColumnName("supervisor_asignado_at_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(e => e.ActualStartUtc).HasColumnName("inicio_real_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.TechnicianFinishedAtUtc).HasColumnName("finalizacion_tecnico_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.FinishedByUserId).HasColumnName("finalizado_por_usuario_id").HasMaxLength(120);
        builder.Property(e => e.SupervisorClosedAtUtc).HasColumnName("cierre_supervisor_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.ClosedByUserId).HasColumnName("cerrado_por_usuario_id").HasMaxLength(120);
        builder.Property(e => e.PlanningValidatedAtUtc).HasColumnName("validacion_planificacion_utc").HasColumnType("datetimeoffset");
        ...
        builder.Property(e => e.UpdatedByUserAtUtc).HasColumnName("actualizado_por_usuario_at_utc").HasColumnType("datetimeoffset");
...
public sealed class WorkOrderTaskConfiguration : IEntityTypeConfiguration<WorkOrderTaskEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderTaskEntity> builder)
    {
        ...
        builder.Property(e => e.Title).HasColumnName("titulo").HasMaxLength(240).IsRequired(); builder.Property(e => e.AcceptanceCriteria).HasColumnName("criterio_aceptacion").HasMaxLength(2000); builder.Property(e => e.StatusId).HasColumnName("estado_id"); builder.Property(e => e.Origin).HasColumnName("origen").HasMaxLength(40); builder.Property(e => e.EstimatedHours).HasColumnName("horas_estimadas").HasColumnType("numeric(12,2)"); builder.Property(e => e.ActualStartUtc).HasColumnName("inicio_real_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.TechnicianCompletedAtUtc).HasColumnName("completada_tecnico_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.CompletedByUserId).HasColumnName("completada_por_usuario_id"); builder.Property(e => e.SupervisorApprovedAtUtc).HasColumnName("aprobada_supervisor_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.ApprovedByUserId).HasColumnName("aprobada_por_usuario_id"); builder.Property(e => e.ObservedAtUtc).HasColumnName("observada_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.ObservedByUserId).HasColumnName("observada_por_usuario_id"); builder.Property(e => e.ObservationReason).HasColumnName("motivo_observacion").HasMaxLength(1000); builder.Property(e => e.CancelledAtUtc).HasColumnName("cancelada_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.CancelledByUserId).HasColumnName("cancelada_por_usuario_id"); builder.Property(e => e.CancellationReason).HasColumnName("motivo_cancelacion").HasMaxLength(1000); builder.Property(e => e.PreventiveTemplateId).HasColumnName("plantilla_preventiva_id"); builder.Property(e => e.PreventiveTemplateItemId).HasColumnName("item_plantilla_preventiva_id"); builder.Property(e => e.PreventiveTemplateVersionSnapshot).HasColumnName("plantilla_preventiva_version_snapshot"); builder.Property(e => e.IsMandatoryPreventive).HasColumnName("obligatoria_preventiva");
        builder.Property(e => e.ScheduledStartUtc).HasColumnName("inicio_programado_utc").HasColumnType("datetimeoffset");
        builder.Property(e => e.ScheduledEndUtc).HasColumnName("fin_programado_utc").HasColumnType("datetimeoffset");
...
public sealed class WorkOrderTechnicianConfiguration : IEntityTypeConfiguration<WorkOrderTechnicianEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderTechnicianEntity> builder)
    {
        ...
        builder.HasIndex(e => new { e.WorkOrderId, e.TechnicianUserId }).IsUnique().HasFilter("vigente = 1").HasDatabaseName("uq_ot_tecnicos_ot_usuario_vigente"); builder.HasIndex(e => new { e.TechnicianUserId, e.IsActive }).HasDatabaseName("ix_ot_tecnicos_usuario_vigente");
    }
}
public sealed class WorkOrderLaborConfiguration : IEntityTypeConfiguration<WorkOrderLaborEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderLaborEntity> builder)
    {
        ...
        builder.Property(e => e.WorkOrderId).HasColumnName("orden_trabajo_id"); builder.Property(e => e.TaskId).HasColumnName("tarea_id"); builder.Property(e => e.TechnicianUserId).HasColumnName("tecnico_usuario_id"); builder.Property(e => e.Hours).HasColumnName("horas").HasColumnType("numeric(12,2)"); builder.Property(e => e.Description).HasColumnName("descripcion").HasMaxLength(1000).IsRequired(); builder.Property(e => e.WorkDateUtc).HasColumnName("fecha_trabajo_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.StartTimeUtc).HasColumnName("hora_inicio_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.EndTimeUtc).HasColumnName("hora_termino_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.RegisteredByUserId).HasColumnName("registrado_por_usuario_id"); builder.Property(e => e.Comment).HasColumnName("comentario").HasMaxLength(1000); builder.Property(e => e.SupervisorValidated).HasColumnName("validado_supervisor"); builder.Property(e => e.ValidatedByUserId).HasColumnName("validado_por_usuario_id"); builder.Property(e => e.ValidatedAtUtc).HasColumnName("validado_at_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.AnnulledByUserId).HasColumnName("anulado_por_usuario_id"); builder.Property(e => e.AnnulledAtUtc).HasColumnName("anulado_at_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.AnnulReason).HasColumnName("motivo_anulacion").HasMaxLength(500); builder.Property(e => e.IsActive).HasColumnName("vigente");
...
public sealed class WorkOrderChecklistConfiguration : IEntityTypeConfiguration<WorkOrderChecklistEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderChecklistEntity> builder)
    {
        ...
        builder.Property(e => e.Completed).HasColumnName("completado"); builder.Property(e => e.CompletedAtUtc).HasColumnName("completado_at_utc").HasColumnType("datetimeoffset");
...
public sealed class WorkOrderSignatureConfiguration : IEntityTypeConfiguration<WorkOrderSignatureEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderSignatureEntity> builder)
    {
        ...
        builder.Property(e => e.WorkOrderId).HasColumnName("orden_trabajo_id"); builder.Property(e => e.SignerUserId).HasColumnName("firmante_usuario_id"); builder.Property(e => e.FileId).HasColumnName("archivo_id"); builder.Property(e => e.SignedAtUtc).HasColumnName("firmado_at_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.Comment).HasColumnName("comentario").HasMaxLength(1000); builder.Property(e => e.ContentHash).HasColumnName("contenido_hash").HasMaxLength(128).IsRequired(); builder.Property(e => e.ContentVersion).HasColumnName("version_contenido"); builder.Property(e => e.IsActive).HasColumnName("vigente"); builder.Property(e => e.InvalidatedByUserId).HasColumnName("invalidada_por_usuario_id"); builder.Property(e => e.InvalidatedAtUtc).HasColumnName("invalidada_at_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.InvalidationReason).HasColumnName("motivo_invalidacion").HasMaxLength(500);
...
public sealed class WorkOrderStatusHistoryConfiguration : IEntityTypeConfiguration<WorkOrderStatusHistoryEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderStatusHistoryEntity> builder)
    {
        ...
        builder.Property(e => e.OccurredAtUtc).HasColumnName("fecha_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.UserId).HasColumnName("usuario_id").HasMaxLength(120).IsRequired(); builder.Property(e => e.Reason).HasColumnName("motivo").HasMaxLength(500).IsRequired();
...
public sealed class DocumentWorkOrderConfiguration : IEntityTypeConfiguration<DocumentWorkOrderEntity>
{
    public void Configure(EntityTypeBuilder<DocumentWorkOrderEntity> builder)
    {
        ...
        builder.Property(e => e.AssignedAtUtc).HasColumnName("asignado_at_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.AssignedByUserId).HasColumnName("asignado_por_usuario_id").HasMaxLength(120);
        builder.Property(e => e.UnassignedAtUtc).HasColumnName("desasignado_at_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.UnassignedByUserId).HasColumnName("desasignado_por_usuario_id").HasMaxLength(120); builder.Property(e => e.UnassignedReason).HasColumnName("motivo_desasignacion").HasMaxLength(500);
        ...
        builder.HasIndex(e => new { e.DocumentId, e.WorkOrderId, e.IsActive }).IsUnique().HasFilter("vigente = 1");
    }
}
...
public sealed class WorkOrderAssetConfiguration : IEntityTypeConfiguration<WorkOrderAssetEntity>
{
    public void Configure(EntityTypeBuilder<WorkOrderAssetEntity> builder)
    {
        ...
        builder.Property(e => e.Role).HasColumnName("rol").HasMaxLength(20).IsRequired(); builder.Property(e => e.AssetCodeSnapshot).HasColumnName("activo_codigo_snapshot").HasMaxLength(80).IsRequired(); builder.Property(e => e.AssetNameSnapshot).HasColumnName("activo_nombre_snapshot").HasMaxLength(240).IsRequired(); builder.Property(e => e.AddedAtUtc).HasColumnName("agregado_en_utc").HasColumnType("datetimeoffset"); builder.Property(e => e.AddedByUserId).HasColumnName("agregado_por_usuario_id").HasMaxLength(120).IsRequired();
