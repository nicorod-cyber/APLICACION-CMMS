...
public interface ISqlServerDevelopmentSeeder
{
...
public sealed class SqlServerDevelopmentSeeder : ISqlServerDevelopmentSeeder
{
    private readonly CmmsDbContext _dbContext;

    public SqlServerDevelopmentSeeder(CmmsDbContext dbContext)
    {
