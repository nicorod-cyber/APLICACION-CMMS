...
public sealed record EquipmentOverviewRow(
    ...
    string? ReadingUnavailableReason,
...
public sealed record AssetDocumentMatrixRow(string TipoDocumento, bool Obligatorio, bool Critico, bool BloqueaDisponibilidad, string Estado, string? DocumentoVigente, int? Version, DateOnly? FechaVencimiento, int? DiasParaVencer, string? MotivoPendencia, string? MatrizId = null, string? RequisitoId = null, bool RequiereFechaVencimiento = false, string? FaenaCodigo = null, string? ActivoNombre = null, string? FaenaNombre = null, string? TipoDocumentalNombre = null);
